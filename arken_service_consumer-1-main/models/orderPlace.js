...
var orderPlaceSchema = new Schema({
  ...
  ordertype: {
    type: String,
    enum: ["Limit", "Market", "Stop", "OCO Limit", "OCO Stop"],
    default: "",
  },
  ...
  site: { type: String, default: "CapitalExc" }, //0-crypto 1-fiat
  ...
  bot_order: {type: String}
});

module.exports = mongoose.model("orderPlace", orderPlaceSchema, "orderPlace");
