...
const DepositNew = () => {
  ...
  const download_csv = () => {
    if (csvData?.length > 0) {
      toast.success("Deposit Details Download Successfully.");
    } else {
              ...
              <div className="px-4 transaction_padding_top">
                <div className="px-2 my-4 transaction_padding_top tops">
                  <div className="headerss">
                    <span className="dash-head">Deposit</span>
                              ...
                              <td>
                                    ...
                                    <td>
                                      {item.status == "COMPLETE" ? (
                                        <span className="plus_14_ff text-green">
                                          {item.status}
                                        </span>
                                      ) : (
                                        <span className="plus_14_ff text-orange">
                                          {item.status}
                                        </span>
                                      )}
                                    </td>
