...
var currencyDetailsSchema = new mongoose.Schema(
    {
        currencyName: { type: String },
        currencySymbol: { type: String },
        walletSymbol: { type: String },
        currencyType: { type: String }, // 1-Coin, 2-Token
        coinType: { type: String }, // 1-Fiat, 2-Crypto
        Currency_image: { type: String },
        status: { type: String },
        depositStatus: { type: String, default: "Active" ,enum: ["Deactive", "Active",]},
        withdrawStatus: { type: String, default: "Active" ,enum: ["Deactive", "Active",]},
        ...
        fixedStakingStatus: { type: String,enum: ["Deactive", "Active",],  default: "Deactive" }, // Active means available for stake else not availble for stake
        flexibleStakingStatus: { type: String, default: "Deactive",enum: ["Deactive", "Active",] }, // Active means available for stake else not availble for stake
        p2p_status: { type: String }, // 2-false,1-true
        ...
        autowithdrawLimit: { type: Number, default: 0 },
        // autowithdrawStatus: { type: String, default: "ACTIVE",enum: ["ACTIVE", "DEACTIVE",], },
        
    },
    { timestamps: true }
);

var currencyDetailsSchemaModal = mongoose.model("Currency", currencyDetailsSchema);

module.exports = currencyDetailsSchemaModal;
